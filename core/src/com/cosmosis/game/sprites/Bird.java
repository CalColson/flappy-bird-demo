...
public class Bird {
    ...
    //private String birdLocation = "bird.png";

    private Rectangle bounds;

    private Texture animationTexture;
    private Animation birdAnimation;
    private String birdAnimationLocation = "birdanimation.png";

    private Sound flap;
    private String flapLocation = "sfx_wing.ogg";

    public Bird(int x, int y) {
        position = new Vector3(x, y, 0);
        velocity = new Vector3(0, 0, 0);

        animationTexture = new Texture(birdAnimationLocation);
        ...
        flap = Gdx.audio.newSound(Gdx.files.internal(flapLocation));
    }
